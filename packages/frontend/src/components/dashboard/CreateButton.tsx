...
const DESIGN_TYPES: DesignType[] = [
  ...
  { id: 'poster', label: 'Poster', icon: '🖼️', width: 800, height: 1200, category: 'Print', description: 'Standard poster' },
  { id: 'business-card', label: 'Business Card', icon: '💳', width: 1050, height: 600, category: 'Print', description: '3.5 x 2 inches' },
  { id: 'flyer', label: 'Flyer', icon: '🗞️', width: 800, height: 1200, category: 'Print', description: 'A4 portrait' },
  { id: 'brochure', label: 'Brochure', icon: '📑', width: 1100, height: 850, category: 'Print', description: 'Tri-fold layout' },
  { id: 'invitation', label: 'Invitation', icon: '💌', width: 800, height: 1100, category: 'Print', description: 'Party invitation' },
  { id: 'birthday-card', label: 'Birthday Card', icon: '🎂', width: 1000, height: 700, category: 'Cards', description: 'Greeting card' },
  { id: 'wedding-card', label: 'Wedding Card', icon: '💍', width: 800, height: 1100, category: 'Cards', description: 'Wedding invitation' },
  { id: 'certificate', label: 'Certificate', icon: '🎓', width: 1200, height: 850, category: 'Documents', description: 'Achievement' },
  { id: 'resume', label: 'Resume', icon: '📋', width: 816, height: 1056, category: 'Documents', description: 'US Letter' },
  { id: 'cv', label: 'CV Template', icon: '📝', width: 210, height: 297, category: 'Documents', description: 'A4 portrait' },
  { id: 'menu', label: 'Menu', icon: '🍽️', width: 800, height: 1200, category: 'Print', description: 'Restaurant menu' },
  { id: 'banner', label: 'Banner', icon: '🎪', width: 1500, height: 500, category: 'Marketing', description: 'Web banner' },
  { id: 'advertisement', label: 'Advertisement', icon: '📢', width: 1080, height: 1080, category: 'Marketing', description: 'Display ad' },
  { id: 'logo', label: 'Logo', icon: '✨', width: 500, height: 500, category: 'Branding', description: 'Brand mark' },
  { id: 'email-template', label: 'Email Template', icon: '📧', width: 600, height: 900, category: 'Digital', description: 'Email layout' },
  { id: 'mobile-app', label: 'Mobile App UI', icon: '📲', width: 390, height: 844, category: 'Web', description: 'iPhone 14 size' },
