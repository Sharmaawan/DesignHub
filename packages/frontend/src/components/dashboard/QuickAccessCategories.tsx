...
const CATEGORIES: Category[] = [
  ...
  { id: 'facebook-post', label: 'Facebook Post', icon: '👍', color: '#1877F2', gradient: 'from-blue-600 to-blue-400', width: 1080, height: 1080 },
  ...
  { id: 'twitter-post', label: 'Twitter/X Post', icon: '🐦', color: '#111827', gradient: 'from-gray-700 to-gray-900', width: 1080, height: 1080 },
