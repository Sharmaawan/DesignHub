...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-canva-blue to-teal-700 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 right-20 w-72 h-72 bg-white rounded-full blur-3xl" />
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-canva-purple rounded-full blur-3xl" />
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-gray-900 text-gray-400">or sign up with email</span>
            </div>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link to="/login" className="text-canva-purple hover:text-canva-purple-dark font-semibold">
              Sign in
            </Link>
          </p>
        </div>
